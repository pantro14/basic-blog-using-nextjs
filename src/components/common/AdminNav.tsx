            ...
            <div>
                ...
                <Link href='/admin' legacyBehavior={true}>
                    <a className='flex items-center space-x-2 p-3 mb-10'>
                        ...
                        {visible && <span
                            className='text-highlight-light dark:text-highlight-dark w-5 h-5 text-xl font-semibold leading-none'>
                        Admin
                        </span>}
                    </a>
                </Link>
                ...
                <div className='space-y-6'>
                    {navItems.map(item => {
                        return (<Link key={item.href} href={item.href} legacyBehavior={true}>
